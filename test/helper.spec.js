...
describe('helper#hasRootPathPrefixInString', () => {
    ...
    it('check if "~/" is at the beginning of the string', () => {
        const tester = pathPathPrefixTester('~');
        const withoutRootPathPrefix = hasRootPathPrefixInString('some/path', tester);
        const withRootPathPrefix = hasRootPathPrefixInString('~/some/path', tester);
